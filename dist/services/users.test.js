    ...
    describe('Services / Users', () => {
        ...
        beforeEach(() => {
            ...
            checkUniqueEmailsSpy = vi
                .spyOn(UsersService.prototype, 'checkUniqueEmails')
                .mockImplementation(() => vi.fn());
            checkPasswordPolicySpy = vi
                .spyOn(UsersService.prototype, 'checkPasswordPolicy')
                .mockResolvedValue(() => vi.fn());
            checkRemainingAdminExistenceSpy = vi
                .spyOn(UsersService.prototype, 'checkRemainingAdminExistence')
                .mockResolvedValue(() => vi.fn());
            checkRemainingActiveAdminSpy = vi
                .spyOn(UsersService.prototype, 'checkRemainingActiveAdmin')
                .mockResolvedValue(() => vi.fn());
            vi.spyOn(UsersService.prototype, 'inviteUrl').mockImplementation(() => vi.fn());
        ...
        describe('updateOne', () => {
            ...
            it.each(['provider', 'external_identifier'])('should throw InvalidPayloadException for non-admin users when updating "%s" field', async (field) => {
                ...
                expect(superUpdateManySpy.mock.lastCall[2].preMutationException.message).toBe(`You can't change the "${field}" value manually.`);
            ...
            it.each(['provider', 'external_identifier'])('should allow null accountability to update "%s" field', async (field) => {
                const service = new UsersService({
                    knex: db,
                    schema: testSchema,
                });
